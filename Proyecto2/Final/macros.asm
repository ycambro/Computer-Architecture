...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Si se van a realizar nuevas macros para un proyecto definirlas aca
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	;ejemplo de uso:            imprimeEnPantalla mensaje longitudMensaje
        %macro imprimeEnPantalla 2
                mov     eax, 4     	; opción 4 de las interrupciones del kernel.
	...
	;ejemplo de uso:	    leeTeclado
        %macro leeTeclado 0
                mov     eax,     3      ; opción 3 de las interrupciones del kernel.
                mov     ebx,     0         ; standar input.
	...
	;ejemplo de uso:	    abreArchivo nombreArchivo
        %macro abreArchivo 1
                mov     eax,     5      ; opción 5 de las interrupciones del kernel.
	...
	%macro leeArchivo 1 
		mov     edx,  128              ; numero de bytes a leer (uno por cada caracter).
        	...
        	mov     eax,  3         ; invoca a 3 (opción 3 de las interrupciones del kernel).
       		int     0x80
	%endmacro
